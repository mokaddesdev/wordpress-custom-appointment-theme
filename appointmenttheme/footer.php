...
<footer class="w-[1366px] bg-[#1F2B6C]  mx-auto px-[187px] pt-[68px] pb-[74px] flex flex-col gap-0">
    <div class="w-full grid grid-cols-4 gap-4">
        ...
        <div class="min-w-[293px] mt-3 logo-description flex flex-col gap-6">
            ...
            <p class="text-[#FCFEFE] font-worksans text-[18px] not-italic font-normal leading-[140%]">Leading the Way in
                Medical Execellence, Trusted Care.</p>
        </div>


        <!-- Important Links -->
        <div class="quick-link ml-6 flex flex-col gap-9">
            <h2 class="text-[#FCFEFE] w-full font-worksans text-[17px] not-italic font-semibold leading-normal">
                Important Links</h2>
            <ul
                class="flex flex-col gap-2 text-[#FCFEFE] font-worksans text-[16px] not-italic font-normal leading-[140%]">
        ...
        <div class="-ml-9 flex flex-col gap-8">
            ...
            <div class="relative w-[272px] h-[50px] ">
                ...
                <!-- Icon Button -->
                <button class="absolute inset-y-0 right-2 flex items-center pr-3 text-gray-500 hover:text-blue-600">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 23 23">
                        <path fill="#1f2b6c"
                            d="m20.745.435-.007.003L1.14 8.544a1.08 1.08 0 0 0-.65.79 1.13 1.13 0 0 0 .306 1.03l3.674 3.674a1.1 1.1 0 0 0 1.398.131l8.952-6.158a.183.183 0 0 1 .255.255l-6.158 8.952a1.1 1.1 0 0 0 .13 1.397l3.675 3.675a1.08 1.08 0 0 0 .982.295 1.1 1.1 0 0 0 .805-.67L22.65 2.35l.002-.01A1.467 1.467 0 0 0 20.745.436" />
                    </svg>
                </button>
            </div>
    ...
    <div class="mt-10 flex justify-between items-center w-full border-t border-[#BFD2F8] pt-6 text-center text-sm">
        <p class="font-worksans text-white text-base font-normal leading-normal pt-5">© 2021 Hospital’s name All Rights
            Reserved by PNTEC-LTD</p>
