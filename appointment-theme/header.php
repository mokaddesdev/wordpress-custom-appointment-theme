...
<body <?php body_class('body-class'); ?> class="m-0 p-0 bg-[#fcfefe]">
    ...
    <?php get_template_part('template-part/sections/header', 'top'); ?>
    <header class=" bg-[#1F2B6C] flex  items-center justify-between gap-6 w-[1366px] mx-auto px-[187px] py-[17px]">
        <nav
            class="flex gap-5 items-center text-[18px] not-italic font-normal leading-normal text-[#FCFEFE] font-worksans">
            <?php
            wp_nav_menu( array(
